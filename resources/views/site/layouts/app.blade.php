...
<body>
    ...
    <header>
        @include('site.layouts.headers.header')
    </header>
    <!-- ::::::  End  Header Section  ::::::  -->

    <!-- ::::::  Start  Breadcrumb Section  ::::::  -->
    @include('site.layouts.breadcrumbs.breadcrumb')
    ...
    @include('site.layouts.modals.modal-add-cart')
    <!-- End Modal Add cart -->

    <!-- Start Modal Quickview cart -->
    @include('site.layouts.modals.modal-quickview-cart')
